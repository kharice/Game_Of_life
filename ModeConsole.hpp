...
#include <fstream> 
#include <sstream>
#include <iomanip> //Pour formater les numéros de fichiers avec zéros de tête (pour écrire 01" par ex.)
#include "Grille.hpp"
...
public :
    ...
    ModeConsole(const std::string& nomFichierEntree); //Constructeur pour exporter la grille
